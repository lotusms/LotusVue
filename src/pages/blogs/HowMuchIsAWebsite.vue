				...
				<div class="col-xs-12 col-md-8">
					<div class="q-ma-md">
						<q-card class="my-card" square>
							<div class="bg-grey-2">
								<q-card-section>
									<h1 class="heading green-text text-h2">How much is a website?</h1>
									<div class="text-subtitle1 date-section q-mt-none">
										<q-icon size="5" name="calendar_today" color="primary" class="icon" />25 Jul 2018
									</div>

									<img
										src="https://raw.githubusercontent.com/lotusms/LotusMS/master/blog/full-image/WebsiteCost.jpg"
										alt="How much is a website?"
									/>
								</q-card-section>
								...
								<q-card-section>
									...
									<p>
										...
										<br />
										<br />By having a budget, your web design company can allocate the necessary manpower and acquire resources while staying within your number. For example, your budget may not be enough to cover a store or content management system. Your web design company will be able to communicate this to you and offer you a startup system that will cover the rest while ensuring there will be room for scaling up to a more complex system in the future. Your web design company can also offer you a retainer (usually 50%) to get the website done until you have the rest of the funds and pay it off before the website is complete. In some cases, web design companies can work with a payment plan. This often comes with a contract and subjects you to legally binding commitments and penalty fees.
										<br />
										<br />Regardless, of what is agreed, make sure you have a budget and that your web design company provides you in writing that they are willing to stay with that budget unless a budget modification is needed and it is communicated with you.
									</p>

									<h4>Getting A Budget For Your Web Design</h4>
									<p>Be realistic when acquiring a budget for your web design. Professional services range from $45/hr - $100/hr, depending on who you talk to. Most web design companies with a brick-and-mortar office have an overhead they have to cover. Their lights must turn on every day. Their water must continue running. And their employees must get paid for ~40hrs/week. These companies are most likely to:</p>
									<ul>
										<li>be more expensive</li>
										<li>have a solid reputation,</li>
										<li>have a place you can come in and settle a complaint if something goes wrong,</li>
										<li>have experts in their hire that specialize in a particular set of skills.</li>
									</ul>

									<p>Other business models, including freelancers, may be a better fit for your budget. These companies:</p>
									<ul>
										<li>have a smaller overhead and are able to offer less expensive solutions,</li>
										<li>run their business online and will come to you,</li>
										<li>have experts working under sub-contracts (they only work when they are called upon),</li>
										<li>are easier to get a hold of and are often open on weekends.</li>
									</ul>

									<p>Once you've decided on your budget size, there are several ways to acquire it. If you have not set aside any funds for marketing or business growth, here is a small list of resources that can help you.</p>
									<ul>
										<li>a business credit card,</li>
										<li>a business loan from a banking institution,</li>
										<li>a PayPal payment option,</li>
										<li>a payment plan from your web design company,</li>
										<li>bartering (your web design company may be interested in a quid-pro-quo relationship)</li>
									</ul>
